...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/tiled/Level5.tmx", nme.NME_assets_tiled_level5_tmx);
			type.set ("assets/tiled/Level5.tmx", Reflect.field (AssetType, "text".toUpperCase ()));
			className.set ("assets/tiled/tilemap_test.png", nme.NME_assets_tiled_tilemap_test_png);
			type.set ("assets/tiled/tilemap_test.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_tiled_level5_tmx extends flash.utils.ByteArray { }
