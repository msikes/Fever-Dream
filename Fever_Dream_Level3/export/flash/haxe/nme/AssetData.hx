...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/tiled/Level3.tmx", nme.NME_assets_tiled_level3_tmx);
			type.set ("assets/tiled/Level3.tmx", Reflect.field (AssetType, "text".toUpperCase ()));
...
class NME_assets_tiled_level3_tmx extends flash.utils.ByteArray { }
