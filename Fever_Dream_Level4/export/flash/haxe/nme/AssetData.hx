...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/tiled/Level4.tmx", nme.NME_assets_tiled_level4_tmx);
			type.set ("assets/tiled/Level4.tmx", Reflect.field (AssetType, "text".toUpperCase ()));
...
class NME_assets_tiled_level4_tmx extends flash.utils.ByteArray { }
