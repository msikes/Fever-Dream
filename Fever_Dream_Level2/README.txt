...
All Level 2 Haxe files, tilesets for Tiled, and assets must be prefixed with L2.
Your Tiled tmx file must be called Level2.tmx and it must work with the 800 x 600px resolution we decided on as a group last week. (Replace the example Tiled files with your own.)
